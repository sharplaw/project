package cc.mrbird.common.util.vedio;
...
public class Contants {
    ...
    public static final String ffmpegpath = "E:/ffmpeg/bin/ffmpeg.exe";     // ffmpeg工具安装位置
    public static final String mencoderpath = "E:/ffmpeg/bin/mencoder";     // mencoder工具安装的位置
